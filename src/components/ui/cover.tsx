...
export const Cover = ({
  ...
  return (
    <div
      ...
      ref={ref}
      className="relative group/cover inline-block dark:bg-transparent px-2 py-2  transition duration-200 rounded-sm"
    >
      <AnimatePresence>
        {hovered && (
          <motion.div
      ...
      <motion.span
        ...
        className={cn(
          "text-[#7800ff] inline-block relative z-20 transition duration-200",
          className
        )}
      >
        {children}
